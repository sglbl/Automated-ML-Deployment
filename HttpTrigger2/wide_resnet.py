...
class WideResNet:
    def __init__(self, image_size, depth=16, k=8):
        ...
        # For regularization / a form of regression, that constrains/ regularizes or shrinks the coefficient estimates towards zero
            ...
            for i, v in enumerate(conv_params):
                if i == 0:
                    ...
                    convs = Conv2D(n_bottleneck_plane, kernel_size=(v[0], v[1]),
                                          ...
                                          kernel_regularizer=l1(self._weight_decay),
...
#    def create_model(self):
    def __call__(self):
        ...
        predictions_a = Dense(units=101, kernel_initializer=self._weight_init, use_bias=self._use_bias,
                              kernel_regularizer=l2(self._weight_decay), activation="softmax", trainable=False)(flatten)

        model = Model(inputs=inputs, outputs=[predictions_g, predictions_a])
        # model.trainable = False
        # model.save_weights("pretrained_models/age_model_sul.hdf5")
