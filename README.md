...
#### Project Structure
The main project folder (<project_root>) contains the following files:
...
#### Publishing function app to Azure -> [Guide](https://docs.microsoft.com/en-us/azure/azure-functions/create-first-function-vs-code-python#publish-the-project-to-azure).